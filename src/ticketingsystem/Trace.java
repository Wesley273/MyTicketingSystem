			...
			threads[i] = new Thread(new Runnable() {
				public void run() {
					...
					for (int i = 0; i < testnum; i++) {
						...
						if (0 <= sel && sel < retpc && soldTicket.size() > 0) { // return
																				// ticket
							...
							if ((ticket = soldTicket.remove(select)) != null) {
								...
								if (tds.refundTicket(ticket)) {
									long postTime = System.nanoTime()
											- startTime;
									System.out.println(preTime + " " + postTime
											+ " " + ThreadId.get() + " "
											+ "TicketRefund" + " " + ticket.tid
											+ " " + ticket.passenger + " "
											+ ticket.route + " " + ticket.coach
											+ " " + ticket.departure + " "
											+ ticket.arrival + " "
											+ ticket.seat);
									// System.out.println(preTime + " " +
									// ThreadId.get() + " " + "TicketRefund" +
									// " " + ticket.tid + " " + ticket.passenger
									// + " " + ticket.route + " " + ticket.coach
									// + " " + ticket.departure + " " +
							...
							int arrival = departure
									+ rand.nextInt(stationnum - departure) + 1; // arrival
																				// is
																				// always
																				// greater
																				// than
																				// departure
							long preTime = System.nanoTime() - startTime;
							if ((ticket = tds.buyTicket(passenger, route,
									departure, arrival)) != null) {
								long postTime = System.nanoTime() - startTime;
								System.out.println(preTime + " " + postTime
										+ " " + ThreadId.get() + " "
										+ "TicketBought" + " " + ticket.tid
										+ " " + ticket.passenger + " "
										+ ticket.route + " " + ticket.coach
										+ " " + ticket.departure + " "
										+ ticket.arrival + " " + ticket.seat);
								// System.out.println(preTime + " " +
								// ThreadId.get() + " " + "TicketBought" + " " +
								// ticket.tid + " " + ticket.passenger + " " +
								// ticket.route + " " + ticket.coach + " " +
								...
								System.out.println(preTime + " " + postTime
										...
										+ departure + " " + arrival);
								// System.out.println(preTime + " " +
								// ThreadId.get() + " " + "TicketSoldOut" + " "
								// + route + " " + departure+ " " + arrival);
								// System.out.flush();
							}
						} else if (buypc <= sel && sel < inqpc) { // inquiry
																	// ticket
							...
							int arrival = departure
									+ rand.nextInt(stationnum - departure) + 1; // arrival
																				...
																				// departure
							long preTime = System.nanoTime() - startTime;
							int leftTicket = tds.inquiry(route, departure,
									arrival);
							long postTime = System.nanoTime() - startTime;
							System.out.println(preTime + " " + postTime + " "
									+ ThreadId.get() + " " + "RemainTicket"
									+ " " + leftTicket + " " + route + " "
									+ departure + " " + arrival);
							// System.out.println(preTime + " " + ThreadId.get()
							// + " " + "RemainTicket" + " " + leftTicket + " " +
							// route+ " " + departure+ " " + arrival);
							// System.out.flush();
